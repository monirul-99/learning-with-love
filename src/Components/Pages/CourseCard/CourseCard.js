...
const CourseCard = ({ item }) => {
  const { title, owner, rating, price, img } = item;
      ...
      >
        ...
        <div className="bg-gray-900 p-4">
          ...
          <button className="mt-4 relative inline-flex items-center justify-center p-3 px-2 py-1 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border border-[#FF2F30] rounded-full shadow-md group">
            ...
            <span className="absolute flex items-center justify-center w-full h-full text-white text-xs transition-all duration-300 transform group-hover:translate-x-full ease">
              Order Now
            </span>
